...
public class Libro_Model {
            ...
            try (ResultSet dataLibro = obtenerLibro.executeQuery()) {
                while(dataLibro.next()){
                    ...
                    if(relaciones){
                        ...
                        if (dataAL != null) {
                            while (dataAL.next()) {
                                autores.add(new Autor(dataAL.getString(1), dataAL.getString(2), dataAL.getString(3), dataAL.getDate(4)));
                            }
                        }
                        
                        if (dataLT != null) {
                            while (dataLT.next()) {
                                temas.add(new Tema(dataLT.getInt(1), dataLT.getString(2)));
                            }
                        }
    ...
    public static boolean insertar(Libro _l){
        ...
        try {
            ...
            insertarSQL.setInt(8, _l.getCategoria().getIdCategoria());

 ...
 * @author Frank
 */
@WebServlet(name = "Reservas.Reporte", urlPatterns = {"/Reservas/Reporte"})
            ...
            if ((Boolean) _s.getAttribute("logged")) {
                ...
                if (_u != null && _u.getTipoUsuario().equals("B")) {
                    try (ServletOutputStream out = response.getOutputStream()) {
                        ...
                        JasperReport reporte = (JasperReport) JRLoader.loadObjectFromFile(getServletContext().getRealPath("reportes/reporte_reservas.jasper"));

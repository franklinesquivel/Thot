        ...
        <main class="">
            <div class="row">
                <div class="col s12 m8 offset-m2">
                    ...
                    <h5><b><fmt:message key="loans.loanDate"/>:</b> ${_p.getFechaPrestamoFormato()}</h5>
                    <h5><b><fmt:message key="loans.finishDate"/>:</b> ${_p.getFechaDevolucionFormato()}</h5>
                    <h5><b><fmt:message key="amount"/>:</b> $${_p.getMora()}</h5>    
            ...
            <br>
            <a href="${path}prestamos.jsp"><fmt:message key="loans"/></a>
        </main>
    </body>
</html>
